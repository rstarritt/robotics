...
public:
    ...
    {
        const astra::ColorizedBodyFrame MaskedColorFrame = frame.get<astra::ColorizedBodyFrame>();
        const int width = MaskedColorFrame.width();
        const int height = MaskedColorFrame.height();
        ...
        const astra::RgbaPixel* vizBuffer = MaskedColorFrame.data();
